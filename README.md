...
更多详情，请看[`/cmd`](https://github.com/reesun/go-project-layout/blob/master/cmd/README.md)目录中的例子。
...
更多样例查看[`/api`](https://github.com/reesun/go-project-layout/blob/master/api/README.md)目录。
...
更多样例查看[`/scripts`](https://github.com/reesun/go-project-layout/blob/master/scripts/README.md)。
...
更多样例查看[`/test`](https://github.com/reesun/go-project-layout/blob/master/test/README.md)。
...
更多样例查看[`/docs`](https://github.com/reesun/go-project-layout/blob/master/docs/README.md)。

### `/tools`

此项目的支持工具。请注意，这些工具可以从`/pkg`和`/internal`目录导入代码。

更多样例查看[`/tools`](https://github.com/reesun/go-project-layout/blob/master/tools/README.md)。

### `/examples`

应用程序或公共库的示例。

更多样例查看[`/examples`](https://github.com/reesun/go-project-layout/blob/master/examples/README.md)。
...
更多样例查看[`/website`](https://github.com/reesun/go-project-layout/blob/master/website/README.md)。
...
[![Release](https://img.shields.io/github/release/golang-standards/project-layout.svg?style=flat-square)](https://github.com/reesun/go-project-layout/releases/latest)
